 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        100 // Seconds    20
  #define THERMAL_PROTECTION_BED_HYSTERESIS     15 // Degrees Celsius     2

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                25 // Seconds        60
  #define WATCH_BED_TEMP_INCREASE               6 // Degrees Celsius    2
#endif
